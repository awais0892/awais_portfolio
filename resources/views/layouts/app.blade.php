...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/logo.svg') }}">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@700&family=Rajdhani:wght@400;600&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        .glow-button {
            box-shadow: 0 0 5px #00F5FF, 0 0 15px #00F5FF;
        ...
        /* Choices.js Custom Cyberpunk Theme */
        .choices {
            margin-bottom: 0;
            font-family: 'Rajdhani', sans-serif;
        }

        /* Fail-safe for native selects when Choices.js fails to init */
        select.js-choice option {
            background-color: #0d1223 !important;
            color: #ffffff !important;
        }

        /* Ensure native select text is always visible against its own background */
        select.js-choice {
        ...
        .choices[data-type*="select-one"].is-open::after {
            border-color: transparent transparent #00F5FF transparent !important;
        }
