...
@section('title', 'Search Results | Awais Ahmad')
@section('description', 'Search results for blog posts on web development, design, and technology.')

@section('content')
    <section class="relative py-20">
        <div class="mx-auto max-w-6xl">
            <div class="mb-14 max-w-3xl">
                <p class="text-sm uppercase tracking-[0.28em] text-cyan-300/70 gsap-reveal">Search Results</p>
                ...
                <p class="mt-5 max-w-2xl text-pretty text-lg leading-8 text-slate-300 gsap-reveal" data-gsap-delay="0.08">
                    @if($blogs->count())
                        Found {{ $blogs->total() }} article{{ $blogs->total() !== 1 ? 's' : '' }} matching your search.
                    @else
            ...
            <div class="glass-card mb-12 rounded-[1.75rem] border border-white/10 bg-slate-950/55 p-6 gsap-reveal" data-gsap-delay="0.16">
                <form action="{{ route('blog.search') }}" method="GET">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center">
                        ...
                        <button type="submit"
                                class="rounded-2xl bg-cyan-400 px-6 py-3 text-sm font-semibold text-slate-950 transition-colors hover:bg-cyan-300 md:flex-shrink-0">
            ...
            @else
                ...
                <div class="glass-card rounded-[1.75rem] border border-white/10 bg-slate-950/55 p-12 text-center gsap-reveal" data-gsap-delay="0.16">
                    <i class="fa-solid fa-search text-6xl text-slate-600 mb-6"></i>
                    <h3 class="text-2xl font-orbitron text-white mb-4">No Results Found</h3>
