...
@section('page-subtitle', 'Add a new blog post to your portfolio.')
...
@section('content')
    <div class="space-y-6">
        <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data" class="admin-surface rounded-[1.75rem] p-8">
            @csrf
            ...
            <div class="grid gap-8 lg:grid-cols-2">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="author" name="author" value="{{ old('author', 'Awais Ahmad') }}" required
                            class="admin-focus w-full rounded-2xl border border-white/10 bg-slate-950/70 px-4 py-3 text-white placeholder:text-slate-500"
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="url" id="featured_image_url" name="featured_image_url" value="{{ old('featured_image_url') }}"
                            class="admin-focus w-full rounded-2xl border border-white/10 bg-slate-950/70 px-4 py-3 text-white placeholder:text-slate-500"
