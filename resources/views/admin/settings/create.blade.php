                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" required
                                ...
                                <option value="text" class="bg-slate-800" {{ old('type') == 'text' ? 'selected' : '' }}>Text
                                </option>
                                <option value="textarea" class="bg-slate-800" {{ old('type') == 'textarea' ? 'selected' : '' }}>Textarea</option>
                                <option value="image" class="bg-slate-800" {{ old('type') == 'image' ? 'selected' : '' }}>
                                    Image</option>
                                <option value="json" class="bg-slate-800" {{ old('type') == 'json' ? 'selected' : '' }}>JSON
                                </option>
                                <option value="boolean" class="bg-slate-800" {{ old('type') == 'boolean' ? 'selected' : '' }}>
                                    Boolean</option>
                                <option value="number" class="bg-slate-800" {{ old('type') == 'number' ? 'selected' : '' }}>
                                    Number</option>
                            </select>
                            @error('type')
                                <p class="text-red-400 text-sm mt-2 flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <select id="group" name="group" required
                                ...
                                <option value="social" class="bg-slate-800" {{ old('group') == 'social' ? 'selected' : '' }}>
                                    Social</option>
                                <option value="contact" class="bg-slate-800" {{ old('group') == 'contact' ? 'selected' : '' }}>Contact</option>
                                <option value="seo" class="bg-slate-800" {{ old('group') == 'seo' ? 'selected' : '' }}>SEO
                                </option>
