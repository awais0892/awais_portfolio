            ...
            <div class="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl">
                <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label class="block text-sm font-bold text-cyan-300 uppercase tracking-wider mb-3">Project Title
                                *</label>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-fuchsia-300 uppercase tracking-wider mb-3">Featured
                                Project</label>
                            <select name="featured"
                                class="js-choice w-full bg-white/10 border border-white/20 rounded-xl px-6 py-4 text-white focus:ring-2 focus:ring-fuchsia-400 focus:border-transparent backdrop-blur-sm transition-all duration-300 text-lg">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-cyan-300 uppercase tracking-wider mb-3">Short Description
                            *</label>
                    ...
                    <div>
                        <label class="block text-sm font-bold text-cyan-300 uppercase tracking-wider mb-3">Detailed
                            Description</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <label
                                class="block text-sm font-bold text-cyan-300 uppercase tracking-wider mb-3">Technologies</label>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-cyan-300 uppercase tracking-wider mb-3">Live Demo
                                URL</label>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-cyan-300 uppercase tracking-wider mb-3">GitHub
                                URL</label>
                    ...
                    <div class="p-6 backdrop-blur-sm bg-white/5 border border-white/10 rounded-2xl">
                        <label class="block text-sm font-bold text-cyan-300 uppercase tracking-wider mb-4">Project
                            Image</label>
