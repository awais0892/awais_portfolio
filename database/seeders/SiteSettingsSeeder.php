...
class SiteSettingsSeeder extends Seeder
{
    ...
    {
        $settings = [
            ['key' => 'site_title', 'value' => 'Awais Ahmad | Professional Software Engineer', 'type' => 'text'],
            ['key' => 'site_description', 'value' => 'Awais Ahmad is a Professional Software Engineer specializing in Laravel and the MERN stack. View his portfolio for innovative web solutions and tech blog.', 'type' => 'text'],
